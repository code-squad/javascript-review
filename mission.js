  ...
  function getArea(polygon, ...theArgs) {
    ...
    if (checkInputResult && checkTypeResult && checkPositiveNum && polygon === 'circle' && theArgs.length === 1) {
      return Math.PI * Math.pow(theArgs[0], 2);
    } else if (checkInputResult && checkTypeResult && checkPositiveNum && polygon === 'rect' && theArgs.length === 2) {
      return theArgs[0] * theArgs[1];
    } else if (checkInputResult && checkTypeResult && checkPositiveNum && polygon === 'trap' && theArgs.length === 3) {
